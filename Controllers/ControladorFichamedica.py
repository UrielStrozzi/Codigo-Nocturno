...
class ControladorFichaMedica:
    ...
    def agregarfichamedica(self, listatratamientos: list[Tratamiento], listaconsulta: list[Consulta]):
                ...
                for consulta in listaconsulta:
                    if consulta.nro == nroconsulta:
                        self.listafichamedica.append(FichaMedica(self.vista.solicitarnro(),
                                                               self.vista.solicitarobservacion(), self.vista.solicitarfechaalta(),
                                                               nrotratamiento,nroconsulta))
    ...
    def modificarfichamedica(self, listatratamientos: list[Tratamiento], listaconsulta: list[Consulta]):
    ...
    def eliminarfichamedica(self):
        ...
        for ficha in self.listafichamedica:
            if ficha.nro == nrofichamedica:
                self.listafichamedica[self.listafichamedica.index(ficha)].dar_baja(self.vista.solicitarfechabaja())
